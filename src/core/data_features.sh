...
keyboardfix_readmelinedescription="Fixes the Fn key in combination with the Function keys (F1, F2...) which happens to not work in some keyboards"
keyboardfix_filekeys=("keyboardconf")
keyboardfix_keyboardconf_path="/etc/modprobe.d/hid_apple.conf"
keyboardfix_keyboardconf_content="options hid_apple fnmode=2"
