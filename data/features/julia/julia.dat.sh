...
julia_tags=("language")
julia_systemcategories=("Building" "ComputerScience" "ConsoleOnly" "DataVisualization" "Development" "Languages" "Math" "NumericalAnalysis" "ParallelComputing" "Science")
...
julia_defaultLauncher_exec="gnome-terminal -- julia"
