...
shotwell_tags=("photoOrganizer" "album" "camera" "cameras" "crop" "edit" "enhance" "export" "gallery" "image" "images" "import" "organize" "photo" "photographs" "photos" "picture" "pictures" "photography" "print" "publish" "rotate" "share" "tags" "video" "facebook" "flickr" "picasa" "youtube" "piwigo" "customDesktop")
