...
jupyterLab_defaultLauncher_exec="bash ${CURRENT_INSTALLATION_FOLDER}/jupyterLab.sh"
jupyterLab_filekeys=("executionscript")
jupyterLab_executionscript_path="jupyterLab.sh"
jupyterLab_executionscript_content="jupyterLab.sh"
