...
gitcm_tags=("customDesktop")
gitcm_systemcategories=("Calculator" "DataVisualization" "Geometry" "Math" "Viewer")
gitcm_binariesinstalledpaths=("git-credential-manager-core;gitcm")
gitcm_downloadKeys=("bundle")
gitcm_bundle_URL="https://github.com/git-ecosystem/git-credential-manager/releases/download/v2.8.0/gcm-linux-x64-2.8.0.tar.gz"
