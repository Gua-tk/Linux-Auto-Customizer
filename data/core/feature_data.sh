...
pulseaudio_packagedependencies=("libpulse0" "pkgconfic" "intltool" "libtool" "libsndfile1-dev" "libjson-c-dev" "build-essential" "dbus-x11" "pulseaudio-module-jack" "mocp")
