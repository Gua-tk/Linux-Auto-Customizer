...
installation_data=(
  "--ant|--apache_ant|--apache-ant;0;0;0;0;0;install_ant"
  "--anydesk;0;0;0;0;0;install_anydesk"
  "--audacity|--Audacity;0;0;0;0;1;install_audacity"
  "--autofirma;0;0;0;0;1;install_AutoFirma"
  "--alert|--alert-alias|--alias-alert;0;0;0;0;0;install_alert"
  "--atom|--Atom;0;0;0;0;1;install_atom"
  "--caffeine|--Caffeine|--cafe|--coffee;0;0;0;0;1;install_caffeine"
  "--calibre|--Calibre|--cali;0;0;0;0;1;install_calibre"
  "--clementine|--Clementine;0;0;0;0;1;install_clementine"
  "--clion|--Clion|--CLion;0;0;0;0;0;install_clion"
  "--cheat|--cheat.sh|--Cheat.sh|--che;0;0;0;0;0;install_cheat"
  "--cheese|--Cheese;0;0;0;0;1;install_cheese"
  "--cmatrix|--Cmatrix;0;0;0;0;1;install_cmatrix"
  "--codium|--vscodium;0;1;0;0;0;install_codium"
  "--converters|--Converters;0;0;0;0;0;install_converters"
  "--clonezilla|--CloneZilla|--cloneZilla;0;0;0;0;1;install_clonezilla"
  "--copyq|--copy-q|--copy_q|--copqQ|--Copyq|--copy-Q;0;0;0;0;1;install_copyq"
  "--curl|--Curl;0;0;0;0;1;install_curl"
  "--discord|--Discord|--disc;0;0;0;0;0;install_discord"
  "--docker|--Docker;0;0;0;0;1;install_docker"
  "--dropbox|--Dropbox|--DropBox|--Drop-box|--drop-box|--Drop-Box;0;0;0;0;1;install_dropbox"
  "--drive|--GoogleDrive|--Drive|--google-drive|--Google-Drive;0;0;0;0;0;install_drive"
  "--document|--google-document;0;0;0;0;0;install_document"
  "--eclipse|--Eclipse;0;0;0;0;0;install_eclipse"
  "--extract-function|-extract_function;0;0;0;0;0;install_extract"
  "--ffmpeg|--youtube-dl-dependencies;0;0;0;0;1;install_ffmpeg"
  "--f-irc|--firc|--Firc|--irc;0;0;0;0;1;install_f-irc"
  "--firefox|--Firefox;0;0;0;0;1;install_firefox"
  "--forms|--google-forms;0;0;0;0;0;install_forms"
  "--freecad|--FreeCAD|--freeCAD;0;0;0;0;1;install_freecad"
  "--gcc|--GCC;0;0;0;0;1;install_gcc"
  "--github|--Github|--GitHub;0;0;0;0;0;install_github"
  "--gpaint|--paint|--Gpaint;0;0;0;0;1;install_gpaint"
  "--geany|--Geany;0;0;0;0;1;install_geany"
  "--geogebra|--geogebra-classic-6|--Geogebra-6|--geogebra-6|--Geogebra-Classic-6|--geogebra-classic;0;0;0;0;0;install_geogebra"
  "--git;0;0;0;0;1;install_git"
  "--git-aliases|--git_aliases|--git-prompt;0;0;0;0;0;install_git_aliases"
  "--GIMP|--gimp|--Gimp;0;0;0;0;1;install_gimp"
  "--gmail|--Gmail;0;0;0;0;0;install_gmail"
  "--GParted|--gparted|--GPARTED|--Gparted;0;0;0;0;1;install_gparted"
  "--gvim|--vim-gtk3|--Gvim|--GVim;0;0;0;0;1;install_gvim"
  "--chrome|--Chrome|--google-chrome|--Google-Chrome;0;0;0;0;1;install_google-chrome"
  "--google-calendar|--Google-Calendar|--googlecalendar;0;0;0;0;0;install_google-calendar"
  "--GNOME_Chess|--gnome_Chess|--gnomechess|--chess;0;0;0;0;1;install_gnome-chess"
  "--history-optimization;0;0;0;0;0;install_history_optimization"
  "--ipe-function|--ipe;0;0;0;0;0;install_ipe"
  "--iqmol|--IQmol;0;0;0;0;1;install_iqmol"
  "--inkscape|--ink-scape|--Inkscape|--InkScape;0;0;0;0;1;install_inkscape"
  "--intellijcommunity|--intelliJCommunity|--intelliJ-Community|--intellij-community|--ideac;0;0;0;0;0;install_ideac"
  "--intellijultimate|--intelliJUltimate|--intelliJ-Ultimate|--intellij-ultimate|--ideau;0;0;0;0;0;install_ideau"
  "--java|--javadevelopmentkit|--java-development-kit|--java-development-kit-11|--java-development-kit11|--jdk|--JDK|--jdk11|--JDK11|--javadevelopmentkit-11;0;0;0;0;0;install_java"
  "--keep|--google-keep|--Keep|--Google-Keep|--googlekeep;0;0;0;0;0;install_keep"
  "--latex|--LaTeX|--tex|--TeX;0;0;0;0;1;install_latex"
  "--alias-l|--alias-ls|--l-alias|--ls-alias|--l;0;0;0;0;0;install_l"
  "--L|--L-function;0;0;0;0;0;install_L"
  "--libgtkglext1;0;0;0;0;1;install_libgtkglext1"
  "--libxcb-xtest0;0;0;0;0;1;install_libxcb-xtest0"
  "--mahjongg|--Mahjongg|--gnome-mahjongg;0;0;0;0;1;install_gnome-mahjongg"
  "--maven|--mvn;0;0;0;0;0;install_mvn"
  "--mega|--Mega|--MEGA|--MegaSync|--MEGAsync|--MEGA-sync|--megasync;0;0;0;0;1;install_megasync"
  "--Mendeley|--mendeley|--mendeleyDesktop|--mendeley-desktop|--Mendeley-Desktop;0;0;0;0;0;install_mendeley"
  "--MendeleyDependencies|--mendeleydependencies|--mendeleydesktopdependencies|--mendeley-desktop-dependencies|--Mendeley-Desktop-Dependencies;0;0;0;0;1;install_mendeley_dependencies"
  "--mines|--Mines|--GNU-mines|--gnome-mines|--gnomemines;0;0;0;0;1;install_gnome-mines"
  "--nemo|--nemo-desktop|--Nemo-Desktop|--Nemodesktop|--nemodesktop|--Nemo|--Nemodesk|--NemoDesktop;0;0;0;0;1;install_nemo"
  "--netflix|--Netflix;0;0;0;0;0;install_netflix"
  "--net-tools|--nettools;0;0;0;0;1;install_net-tools"
  "--notepadqq|--Notepadqq|--notepadQQ|--NotepadQQ|--notepadQq|--notepadQq|--NotepadQq|--NotepadqQ;0;0;0;0;1;install_notepadqq"
  "--onedrive|--OneDrive|--one-drive|--One-Drive;0;0;0;0;0;install_onedrive"
  "--outlook|--Outlook;0;0;0;0;0;install_outlook"
  "--openoffice|--office|--Openoffice|--OpenOffice|--openOfice|--open_office|--Office;0;0;0;0;1;install_openoffice"
  "--OBS|--obs|--obs-studio|--obs_studio|--obs_Studio|--OBS_studio|--obs-Studio|--OBS_Studio|--OBS-Studio;0;0;0;0;1;install_obs-studio"
  "--okular|--Okular|--okularpdf;0;0;0;0;1;install_okular"
  "--overleaf|--Overleaf;0;0;0;0;0;install_overleaf"
  "--pacman|--pac-man;0;0;0;0;1;install_pacman"
  "--parallel|--gnu_parallel|--GNUparallel|--GNUParallel|--gnu-parallel;0;0;0;0;1;install_parallel"
  "--pdfgrep|--findpdf;0;0;0;0;1;install_pdfgrep"
  "--pluma;0;0;0;0;1;install_pluma"
  "--presentation|--google-presentation;0;0;0;0;0;install_presentation"
  "--prompt;0;0;0;0;0;install_prompt"
  "--postgreSQL|--PostGreSQL|--postgresql|--postgre-sql|--postgre-SQL|--psql|--pSQL|--p-SQL|--p-sql;0;0;0;0;1;install_psql"
  "--pycharmcommunity|--pycharmCommunity|--pycharm_community|--pycharm|--pycharm-community;0;0;0;0;0;install_pycharm"
  "--pycharmpro|--pycharmPro|--pycharm_pro|--pycharm-pro|--Pycharm-Pro|--PyCharm-pro;0;0;0;0;0;install_pycharmpro"
  "--python|--python3|--Python3|--Python;0;0;0;0;1;install_python3"
  "--pypy|--pypy3|--PyPy3|--PyPy;0;0;0;0;0;install_pypy3"
  "--dependencies|--pypy3_dependencies|--pypy3Dependencies|--PyPy3Dependencies|--pypy3dependencies|--pypy3-dependencies;0;0;0;0;1;install_pypy3_dependencies"
  "--steam|--Steam|--STEAM;0;0;0;0;1;install_steam"
  "--screenshots|--Screenshots;0;0;0;0;0;install_screenshots"
  "--shotcut|--ShotCut|--Shotcut|--shot-cut|--shot_cut;0;0;0;0;1;install_shotcut"
  "--shortcuts;0;0;0;0;0;install_shortcuts"
  "--solitaire|--Solitaire|--gnome-solitaire|--aisleriot;0;0;0;0;1;install_aisleriot"
  "--s|--s-function;0;0;0;0;0;install_s"
  "--skype|--Skype;0;0;0;0;1;install_skype"
  "--slack|--Slack;0;0;0;0;1;install_slack"
  "--studio|--android|--AndroidStudio|--androidstudio|--android-studio|--android_studio|--Androidstudio;0;0;0;0;0;install_studio"
  "--sublime|--sublimeText|--sublime_text|--Sublime|--sublime-Text|--sublime-text;0;0;0;0;0;install_sublime"
  "--spotify|--Spotify;0;0;0;0;1;install_spotify"
  "--spreadsheets|--google-spreadsheets;0;0;0;0;0;install_spreadsheets"
  "--sudoku|--Sudoku|--gnome-sudoku;0;0;0;0;1;install_gnome-sudoku"
  "--Telegram|--telegram;0;0;0;0;0;install_telegram"
  "--templates;0;0;0;0;0;install_templates"
  "--terminal-background|--terminal_background;0;0;0;0;0;install_terminal_background"
  "--Terminator|--terminator;0;0;0;0;1;install_terminator"
  "--Tilix|--tilix;0;0;0;0;1;install_tilix"
  "--tmux|--Tmux;0;0;0;0;1;install_tmux"
  "--teams|--Teams|--MicrosoftTeams;0;0;0;0;1;install_teams"
  "--uget;0;0;0;0;1;install_uget"
  "--thunderbird|--mozillathunderbird|--mozilla-thunderbird|--Thunderbird|--thunder-bird;0;0;0;0;1;install_thunderbird"
  "--tor|--torbrowser|--tor_browser|--TOR|--TOR-browser|--TOR-BROSWER|--TORBROWSER|--TOR_BROWSER|--TOR_browser;0;0;0;0;1;install_tor"
  "--transmission|--transmission-gtk|--Transmission;0;0;0;0;1;install_transmission"
  "--virtualbox|--virtual-box|--VirtualBox|--virtualBox|--Virtual-Box|--Virtualbox;0;0;0;0;1;install_virtualbox"
  "--code|--visualstudiocode|--visual-studio-code|--Code|--visualstudio|--visual-studio;0;0;0;0;0;install_code"
  "--vlc|--VLC|--Vlc;0;0;0;0;1;install_vlc"
  "--Wallpapers|--wallpapers|--chwlppr;0;0;0;0;0;install_chwlppr"
  "--youtube-dl;0;0;0;0;0;install_youtube-dl"
  "--whatsapp|--Whatsapp;0;0;0;0;0;install_whatsapp"
  "--wireshark|--Wireshark;0;0;0;0;1;install_wireshark"
  "--youtube|--Youtube|--YouTube;0;0;0;0;0;install_youtube"
  "--youtubemusic|--YouTubeMusic|--YouTube-Music|--Youtube-Music|--youtube-music;0;0;0;0;0;install_youtubemusic"
  "--Zoom| --zoom;0;0;0;0;0;install_zoom"
)
