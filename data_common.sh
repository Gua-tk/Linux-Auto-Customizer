...
declare -r wrapper_iochemroot=("gcc" "virtualbox" "uget" "pdfgrep" "obs" "nemo" "gpaint" "guake" "parallel" "calculator" "autofirma" "dia" "psql" "chrome" "caffeine" "copyq" "thunderbird" "vlc" "python" "git" "teams" "customizer")
declare -r wrapper_iochemuser=("anydesk" "telegram" "eclipse" "fastcommands" "cheat" "apache" "java" "ant" "mvn" "terminal-background" "bashcolors" "pycharm" "sublime" "gitcm" "wallpapers" "java" "ideac" "ideau" "pgadmin" "a" "add" "alert" "b" "B" "c" "changebg" "checkout" "clean" "clone" "commit" "d" "dummycommit" "e" "E" "emojis" "f" "F" "fetch" "h" "hard" "i" "ipe" "ipi" "j" "k" "l" "L" "loc" "merge" "o" "port" "pull" "push" "q" "s" "u" "x" "z" "status" "gitprompt" "history_optimization" "meld" "mendeley" "onedrive" "postman" "prompt" "gitprompt" "screenshots" "sherlock" "shortcuts" "sonarqube" "templates" "wikit" "youtube-music" "youtube-dl" "zoom" "whatsapp")
