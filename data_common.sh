...
declare -r wrapper_iochemuser=("anydesk" "telegram" "eclipse" "fastcommands" "cheat" "apache" "teams" "java" "ant" "mvn" "terminal-background" "bashcolors" "pycharm" "sublime" "gitcm" "wallpapers" "java" "ideac" "ideau" "pgadmin" "a" "add" "alert" "b" "B" "c" "changebg" "checkout" "clean" "clone" "commit" "d" "dummycommit" "e" "E" "emojis" "f" "F" "fetch" "h" "hard" "i" "ipe" "ipi" "j" "k" "l" "L" "loc" "merge" "o" "port" "pull" "push" "q" "s" "u" "x" "z" "status" "gitprompt" "history_optimization" "customizer" "meld" "mendeley" "onedrive" "postman" "prompt" "gitprompt" "screenshots" "sherlock" "shortcuts" "sonarqube" "templates" "wikit" "youtube-music" "zoom" "whatsapp")
