...
installation_data=(
  ...
  "--changebg|--wallpapers|--Wallpapers|--change-bg;0;| Function \`change-bg\` | Function that changes the wallpaper using one random image from user images folder. It also downloads wallpapers and installs a cronjob to change the wallpaper every 5 minutes | Function \`change-bg\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
