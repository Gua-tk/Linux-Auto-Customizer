...
#   - The rest
installation_data=(
  "--a;0;| Function \`a\` | Prints a list of aliases using \`compgen -a\` | Command \`a\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  "--add;0;| Function \`add\` | alias for \`git add\` | Command \`add\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--changebg|--wallpapers|--Wallpapers|--change-bg;0;| Function \`changebg\` | Function that changes the wallpaper using one random image from user images folder. It also downloads wallpapers and installs a cronjob to change the wallpaper every 5 minutes | Function \`changebg\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--clean|--function-clean|--clean-function;0;| Function \`clean\` | Remove files and contents from the trash bin and performs \`sudo apt-get -y autoclean\` and \`sudo apt-get -y autoremove\`. | Command \`clean\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--dconf-editor|--dconf|;1;| dconf-editor | Editor settings | Command \`dconf-editor\` and desktop and dashboard launcher ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--documents|--google-document;0;| Google Documents | Google Document opening in Chrome | Command \`document\` and desktop and dashboard launcher ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--github|--Github|--GitHub;0;| GitHub | GitHub opening in Chrome | Command \`github\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  "--github-desktop|--Github-Desktop|--GitHub-Desktop;1;| GitHub Desktop | GitHub Application | Command \`github-desktop\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--gnat-gps|--gnat-programming-studio|--gnat-ps|--gnatps|--gnatgps|--gnat;1;| GNAT | Programming Studio for Ada and C | Command \`gnat-gps\`, desktop launcher and dashboard launcher ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--j;0;| Function \`j\` | alias for jobs -l | Commands \`j\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--jupyter-lab|--jupyter-notebook|--jupyter|--jupyterlab;0;| Jupyter Lab | IDE with a lot of possible customization and usable for different programming languages.| alias \`lab\`, commands \`jupyter-lab\`, \`jupyter-lab\`, \`ipython\`, \`ipython3\`, desktop launcher and dashboard launcher. Recognized programming languages: Python, Ansible, Bash, IArm, Kotlin, PowerShell, Vim. || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--lolcat;1;| lolcat | Same as the command \`cat\` but outputting the text in rainbow color and concatenate string | command \`lolcat\`, alias \`lol\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--npm;0;| NodeJS npm | JavaScript packagemanager for the developers. | Command \`node\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
