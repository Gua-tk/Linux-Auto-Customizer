...
installation_data=(
  ...
  "--documents|--google-document;0;| Document | Google Document opening in Chrome | Command \`document\` and desktop and dashboard launcher ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
