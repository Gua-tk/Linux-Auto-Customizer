...
installation_data=(
  ...
  "--ijs;0;| iJavaScript | JavaScript kernel for jupyter ecosystem | Dependency to install IJavaScript in Jupyter Notebook || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--nedit|--NEdit|--Nirvana-Editor|--nirvanaeditor|--nirvana|--Nirvana|--nirvana-editor;1;| NEdit | Multi-purpose text editor and source code editor | Command \`nedit\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--python3|--python|--Python3|--Python;1;| Python3 | Interpreted, high-level and general-purpose programming language | Commands \`python\`, \`python3\`, \`pip3\` and Function \`v\` for virtual environment activation/deactivation in the PATH ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> | "
  "--reddit|--Reddit;0;| Reddit | Opens Reddit in Chrome | Commands \`reddit\`|| <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |  "
  "--R|--r-base;1;| R | Programming language | Commands \`R\`, Desktop Launcher|| <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |  "
  ...
  "--scala|--Scala;1;| Scala | Programming language | Command \`s \"scala\"\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
