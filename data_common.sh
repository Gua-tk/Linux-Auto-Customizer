...
installation_data=(
  ...
  "--bi;0;| Fix broken install | alias for \`(sudo apt --fix-broken install)\` | Command \`bi\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  "--branch;0;| \`branch\` | alias for \`git branch -vv\` | Command \`branch\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--checkout;0;| \`checkout\` | alias for \`git checkout\` | Command \`checkout\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--j;0;| jobs | alias for jobs -l | Commands \`j\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--lol;0;| lol | alias to \`lolcat\`  | command \`lol\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--node;0;| NodeJS npm and npx | JavaScript for the developers. | Command \`nodejs\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--r-base|--R;1;| R | Programming language | Commands \`R\`|| <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |  "
  "--remmina;1;| Remmina | Remote Desktop Contol | Commands \`remmina\`, Desktop launcher and Icon || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |  "
  "--rustc;1;| Rust | Programming Language | Commands \`rustc\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |  "
  ...
  "--u;0;| \`u\` | Opens given link in default web browser | Command \`u\` ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
