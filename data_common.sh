...
installation_data=(
  ...
  "--cheese|--Cheese;1;| Cheese | GNOME webcam application | Command \`cheese\`, desktop launcher and dashboard launcher | --cheese ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--cmatrix|--Cmatrix;1;| Cmatrix | Terminal screensaver from The Matrix | Command \`cmatrix\`, desktop launcher and dashboard launcher ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--dummycommit;1;| dummycommit | Do the following commands \`git add -a\` \`git commit -am \$1\` \`git push\` | Command \`dummycommit\`|| <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--fetch;1;| fetch| \`git fetch\`| Command \`fetch\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--k;1;| k | \`alias for gitk\` | Command \`k\`|| <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--mvn|--maven;0;| Maven | Build automation tool used primarily for Java projects | Command \`mvn\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--o;0;| Alias \`o\` | Alias for \`nemo-desktop\` | Alias \`o\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--pluma;1;| pluma | Fork of gedit 2.0 that supports many plugins and new features |  | --pluma |  <ul><li>- [ ] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--python3|--python|--Python3|--Python;1;| Python3 | Interpreted, high-level and general-purpose programming language | Commands \`python\`, \`python3\` and \`pip3\` in the PATH ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> | "
  ...
  "--spotify|--Spotify;1;| Spotify | Music streaming service | Command \`spotify\`, desktop launcher, dashboard launcher || <ul><li>- [x] root</li><li>- [] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> | "
  "--spreadsheets|--google-spreadsheets;0;| Spreadsheets | Google Spreadsheets opening in Chrome | Command \`spreadsheets\`, desktop launcher, dashboard launcher || <ul><li>- [x] root</li><li>- [] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> | "
  "--status;1;| status | \`git status\` | Command \`status\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--synaptic|--Synaptic;1;| Synaptic | Package installation manager | Command \`synaptic\`, desktop launcher, dashboard launcher || <ul><li>- [x] root</li><li>- [] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> | "
  "--sysmontask|--SysMonTask;1;| Sysmontask | Control panel for linux | Command \`sysmontask\`, desktop launcher, dashboard launcher || <ul><li>- [x] root</li><li>- [] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> | "
  ...
  "--transmission|--transmission-gtk|--Transmission;1;| Transmission | A set of lightweight Torrent client (in GUI, CLI and daemon form) | Executable \`transmission\`, desktop launcher and dashboard launcher ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
