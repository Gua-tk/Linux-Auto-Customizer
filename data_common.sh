...
installation_data=(
  ...
  "--openssl102;1;| openssl1.0 | RStudio dependency | <-- ||  <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
  ...
  "--r-base|--R;1;| R | Programming language | Commands \`R\`, Desktop Launcher|| <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |  "
  ...
  "--scala|--Scala;1;| Scala | Programming language | Function \`s \"scala\"\` || <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |"
