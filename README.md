...
| Cmatrix | Screensaver from The Matrix | Command `cmatrix`, desktop launcher and dashboard launcher | --cmatrix --Cmatrix | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
