...
| GitHub | GitHub opening in Chrome | Command | --github --Github --GitHub | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Google Calendar | Google Calendar opening in Chrome | Command `google-calendar`, desktop launcher and dashboard launcher | --google-calendar --Google-Calendar --googlecalendar | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Whatsapp Web | Whatsapp web opens in Chrome | Command `whatsapp`, desktop launcher and dashboard launcher | --whatsapp --Whatsapp | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
