...
| Function `chwlppr` | Function that changes the wallpaper using one random image from user images folder. It also downloads wallpapers and installs a cronjob to change the wallpaper every 5 minutes | Function `chwlppr` | --wallpapers | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| pluma | Fork of gedit 2.0 that supports many plugins and new features |  | --pluma | <ul><li>- [ ] root</li><li>- [ ] user</li></ul> | <ul><li>- [ ] Ubuntu</li><li>- [ ] Debian</li></ul> |
| prompt | Installs a new prompt on terminal window | Adds a personalized prompt that shows the date, return code of last executed program, user, group and working directory. It also changes the prompt colour of introduced text to green | --prompt | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Slack | Platform to coordinate your work with a team |  | --slack | <ul><li>- [ ] root</li><li>- [ ] user</li></ul> | <ul><li>- [ ] Ubuntu</li><li>- [ ] Debian</li></ul> |
