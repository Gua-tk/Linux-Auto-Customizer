...
| Alias `b` | Alias for `bash` | Alias `b` | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| Alias `l` | Alias for `ls -lah` | Alias `l` | --l | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| Alias `o` | Alias for `nemo-desktop` | Alias `o` | --l | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| AutoFirma | Electronic signature recognition | Command `AutoFirma` and desktop and dashboard launcher | --AutoFirma --autofirma | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Aspell | Spell checker | Command `aspell` | --aspell | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| bashcolors | bring color to terminal | Command `bashcolors` | --bashcolors | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| dconf-editor | Editor settings | Command `dconf-editor` and desktop and dashboard launcher | --dconf-editor | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| dummycommit | Do the following commands `git add -a` `git commit -am $1` `git push` | Command `dummycommit`| --dummycommit | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| k | `alias for gitk` | Command `k`| --k | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Calculator | GUI calculator| Commmand `calculator`, desktop launcher and dashboard launcher | --gnome-calculator --GNOME_Calculator --gnomecalculator --calculator | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| evolution | User calendar agend, planning | Command `user` <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| fetch| `git fetch` | Command `fetch` | --fetch | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| fslint | Duplicate file finder for linux for disk organization | Command `fslint` | --fslint | <ul><li>- [1] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Function `--c` | Function `c` that changes the directory or clears the screen | Function `--c | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| Function `--commit` | Function `commit` that makes `git commit -am "$1"` | Function `--commit | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| Function `--e` | Multi Function `e` to edit a file or project in folder | Function `--e | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Function `system-fonts` | Function to set custom fonts predefinedly | Function `system-fonts"` | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Geany | Lightweight GUI text editor u``sing Scintilla and GTK, including basic IDE features | Command `geany`, desktop launcher and dashboard launcher | --geany --Geany | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| gnome-terminal | Terminal of the system | --gnome-terminal --terminal --Terminal | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Gitk | GUI for git | Command | --gitk | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| gitprompt | Special prompt in git repositories | Command `gitprompt`| --gitprompt | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| libgtkglext1 | Anydesk dependency | Used when Anydesk is run | --libgtkglext1 | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| l alias | alias for `ls` | command `l` | --l --alias-l --alias-ls --l-alias --ls-alias | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| PostGreSQL | Installs `psql`|  Command `psql` | --prompt | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| Grsync | Installs `grsync`, desktop launcher... | Commands `grsync`| --rsync --Reddit | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |  
...
| status | `git status` | Command `status` | --status | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |  
...
| shortcuts | Installs custom key commands | Command `shortcuts` || <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
| Skype | Call & conversation tool service |  | --skype | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [ ] Ubuntu</li><li>- [ ] Debian</li></ul> |
...
| font Msttcorefonts | Windows classic fonts | Install mscore fonts | -msttcorefonts --microsoftfonts --microsoft-fonts --mscorefonts --ttf-mscorefonts | <ul><li>- [x] root</li><li>- [ ] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> | 
...
| Trello | Trello web opens in Chrome | Command `trello`, desktop launcher and dashboard launcher | --trello --Trello | <ul><li>- [ ] root</li><li>- [x] user</li></ul> | <ul><li>- [x] Ubuntu</li><li>- [ ] Debian</li></ul> |
